...
Before tests can be run locally, Pozoqo Core must be built.  See the [building instructions](/doc#building) for help.
...
Many Pozoqo specific tests require pozoqo_hash. To install it:

- Clone the repo `git clone https://github.com/pozoqoproject/pozoqo_hash`
