...
class LLMQCoinbaseCommitmentsTest(PozoqoTestFramework):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as PozoqoTestFramework doesn't support this atm)
