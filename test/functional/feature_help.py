...
"""Verify that starting pozoqod with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pozoqod with -h for help text")
        ...
        self.log.info("Start pozoqod with -version for version information")
        ...
        self.log.info("Start pozoqodd with -fakearg to make sure it does not start")
