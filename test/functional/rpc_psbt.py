...
class PSBTTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 PZQ
        ...
        # feeRate of 0.1 PZQ / KB produces a total fee slightly below -maxtxfee (~0.06650000):
        ...
        # feeRate of 10 PZQ / KB produces a total fee well above -maxtxfee
