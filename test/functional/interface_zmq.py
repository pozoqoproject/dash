...
from test_framework.messages import pozoqohash
...
def pozoqohash_helper(b):
    return encode(pozoqohash(b)[::-1], 'hex_codec').decode('ascii')
...
class ZMQTest (BitcoinTestFramework):
    ...
    def _zmq_test(self):
        ...
        for x in range(num_blocks):
            ...
            assert_equal(genhashes[x], pozoqohash_helper(block[:80]))
