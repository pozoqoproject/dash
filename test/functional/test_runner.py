...
BASE_SCRIPTS = [
    ...
    # Longest test should go first, to favor running tests in parallel
    'feature_dip3_deterministicmns.py', # NOTE: needs pozoqo_hash to pass
    ...
    'feature_block.py', # NOTE: needs pozoqo_hash to pass
    ...
    'feature_llmq_signing.py', # NOTE: needs pozoqo_hash to pass
    'feature_llmq_signing.py --spork21', # NOTE: needs pozoqo_hash to pass
    ...
    'feature_llmq_is_retroactive.py', # NOTE: needs pozoqo_hash to pass
    'feature_llmq_dkgerrors.py', # NOTE: needs pozoqo_hash to pass
    'feature_dip4_coinbasemerkleroots.py', # NOTE: needs pozoqo_hash to pass
    # vv Tests less than 60s vv
    'p2p_sendheaders.py', # NOTE: needs pozoqo_hash to pass
    'p2p_sendheaders_compressed.py', # NOTE: needs pozoqo_hash to pass
    ...
    'p2p_unrequested_blocks.py', # NOTE: needs pozoqo_hash to pass
    'feature_shutdown.py',
    'rpc_coinjoin.py',
    'rpc_masternode.py',
    'rpc_mnauth.py',
...
def main():
    ...
    # args to be passed on always start with two pozoqoes; tests are the remaining unknown args
...
def run_tests(*, test_list, src_dir, build_dir, tmpdir, jobs=1, enable_coverage=False, args=None, combined_logs_len=0,failfast=False, runs_ci=False):
    ...
    try:
        pidof_output = subprocess.check_output(["pidof", "pozoqod"])
