...
This document provides guidelines for internationalization of the Pozoqo Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `pozoqo_en.ts` remains unchanged.
