# Support for Output Descriptors in Pozoqo Core

Since Pozoqo Core v0.17, there is support for Output Descriptors. This is a
...
existing Pozoqo Core wallets, a convenience function `combo` is
...
All RPCs in Pozoqo Core will include the checksum in their output. Only
