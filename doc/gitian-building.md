...
```bash
    ...
    From https://github.com/pozoqoproject/pozoqo
...
[pozoqo/gitian.sigs](https://github.com/pozoqoproject/gitian.sigs/) repository, or if that's not possible to create a pull
request.
