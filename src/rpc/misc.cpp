...
static UniValue debug(const JSONRPCRequest& request)
{
    RPCHelpMan{"debug",
        ...
        " - \"pozoqo\" activates all Pozoqo-specific categories at once;\n"
        ...
        RPCExamples {
            HelpExampleCli("debug", "pozoqo")
    + HelpExampleRpc("debug", "pozoqo+net")
    }}.Check(request);
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Pozoqo features */
    { "pozoqo",               "mnsync",                 &mnsync,                 {} },
    { "pozoqo",               "spork",                  &spork,                  {"command"} },
    { "pozoqo",               "sporkupdate",            &sporkupdate,            {"name","value"} },
