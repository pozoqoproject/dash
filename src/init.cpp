...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/pozoqoproject/pozoqo>";
    ...
    while (!fLoaded && !ShutdownRequested()) {
        ...
        do {
            ...
            try {
                ...
                if (!fDisableGovernance && !args.GetBoolArg("-txindex", DEFAULT_TXINDEX) && chainparams.NetworkIDString() != CBaseChainParams::REGTEST) { // TODO remove this when pruning is fixed. See https://github.com/pozoqoproject/pozoqo/pull/1817 and https://github.com/pozoqoproject/pozoqo/pull/1743
