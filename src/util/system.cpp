...
// Copyright (c) 2022-2023 The Pozoqo Core developers
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\PozoqoCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\PozoqoCore
    // Mac: ~/Library/Application Support/PozoqoCore
    // Unix: ~/.pozoqocore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "PozoqoCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/PozoqoCore";
#else
    // Unix
    return pathRet / ".pozoqocore";
#endif
#endif
}
