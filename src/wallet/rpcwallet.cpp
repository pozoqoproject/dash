...
static UniValue sendtoaddress(const JSONRPCRequest& request)
{
    ...
    "                             The recipient will receive less amount of Pozoqo than you enter in the amount field."},
...
static UniValue listaddressbalances(const JSONRPCRequest& request)
{
    RPCHelpMan{"listaddressbalances",
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::STR_AMOUNT, "amount", "The pozoqo address and the amount in " + CURRENCY_UNIT},
            }
        },
        RPCExamples{
...
static UniValue sendmany(const JSONRPCRequest& request)
{
    RPCHelpMan{"sendmany",
            ...
            "                           Those recipients will receive less pozoqo than you enter in their corresponding amount field.\n"
...
static UniValue addmultisigaddress(const JSONRPCRequest& request)
{
    RPCHelpMan{"addmultisigaddress",
        ...
        "If 'label' is specified, assign address to that label.\n",
        {
            ...
            {"keys", RPCArg::Type::ARR, RPCArg::Optional::NO, "A json array of pozoqo addresses or hex-encoded public keys",
                {
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "", Cat(Cat<std::vector<RPCResult>>(
                    {
                        {RPCResult::Type::BOOL, "involvesWatchonly", "Only returns true if imported addresses were involved in transaction"},
                        {RPCResult::Type::STR, "address", "The pozoqo address of the transaction. Not present for\n"
...
static UniValue walletpassphrase(const JSONRPCRequest& request)
{
    RPCHelpMan{"walletpassphrase",
        ...
        "This is needed prior to performing transactions related to private keys such as sending pozoqo\n"
        "\nNote:\n"
...
static UniValue lockunspent(const JSONRPCRequest& request)
{
    RPCHelpMan{"lockunspent",
        ...
        "A locked transaction output will not be chosen by automatic coin selection, when spending pozoqo.\n"
...
static UniValue listunspent(const JSONRPCRequest& request)
{
    ...
    RPCHelpMan{"listunspent",
        ...
        "Optionally filter to only include txouts paid to specified addresses.\n",
        {
            ...
            {"addresses", RPCArg::Type::ARR, /* default */ "empty array", "A json array of pozoqo addresses to filter",
                {
...
UniValue getaddressinfo(const JSONRPCRequest& request)
{
    RPCHelpMan{"getaddressinfo",
        "\nReturn information about the given pozoqo address. Some information requires the address\n"
        "to be in the wallet.\n",
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The pozoqo address to get the information of."},
        },
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
