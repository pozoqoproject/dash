...
//! Interface for the src/evo part of a pozoqo node (pozoqod process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a pozoqo node (pozoqod process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a pozoqo node (pozoqod process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a pozoqo node (pozoqod process).
...
//! Top-level interface for a pozoqo node (pozoqod process).
class Node
{
public:
    virtual ~Node() {}
